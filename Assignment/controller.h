...
void runUser()
{
    ...
    cout << "Order of Display: " << orderLinkedList.orderOfDisplay << endl;
    ...
    cout << "5) Change Order of Display" << endl;
    ...
    switch (opt){
        ...
        case 5:
        {
            cout << "Please select the order of display." << endl;
            ...
            switch (opt){
                case 1:
                {
                    orderLinkedList.orderOfDisplay = "Ascending";
                    break;
                }
                case 2:
                {
                    orderLinkedList.orderOfDisplay = "Descending";
                    break;
                }
